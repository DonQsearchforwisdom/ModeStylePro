...
const STYLE_OPTIONS: Record<'여성' | '남성', StyleItem[]> = {
  여성: [
    ...
    },
    {
      ...
      upsell: '추가 제안 : 두피 보호제 + 컬러 케어 (60,000원 ~ 90,000원)',
    ...
    },
    {
      ...
      upsell: '추가 제안 : 사이드 다운펌 + 백볼륨 (40,000원 ~ 60,000원)',
  ...
  남성: [
    ...
    },
    {
      ...
      upsell: '추가 제안 : 아이롱 열펌 + 페이드 쉐이빙 (80,000원 ~ 100,000원)',
    ...
    },
    {
      ...
      upsell: '추가 제안 : 하드 핀컬펌 + 두피 스케일링 (50,000원 ~ 70,000원)',
      careOption: '🧪 하드 펌 전용 진정 수분 트리트먼트',
      careCost: '추가 비용 : 50,000원 ~ 60,000원',
    ...
    },
    {
      ...
      upsell: '추가 제안 : 탈색 2회 + 보색 + 클리닉 (120,000원 ~ 160,000원)',
